...
export default (
  <Slide key={uuid()}>
    ...
    <A>
      <Subtitle>
        <RainbowText text="Never Forget - Take That" />
        <RainbowText text="(JSConf EU 2xAA cover)" />
      </Subtitle>
      <br />
      <Subtitle>
        <a href="https://soundcloud.com/2xaa/never-forget-take-that-jsconf-eu-2xaa-cover">
          soundcloud.com/2xaa
        </a>
      </Subtitle>
